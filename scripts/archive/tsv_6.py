...
for i in range(len(mut_list)):
    ...
    ref_seq_aa_match_final, mut_seq_aa_match_final = [], []
    ref_seq_aa_rc_match_final, mut_seq_aa_rc_match_final = [], []
    for pos_shift in [0, 1, 2]:
        ...
        if not ref_seq_rc_aa_match:
            ...
            if not mut_seq_rc_aa_match:
                ...
                mut_seq_rc = ""
                mut_seq_rc_aa = ""
        ref_seq_final.append(ref_seq)
        mut_seq_final.append(mut_seq)
        ref_seq_rc_final.append(ref_seq_rc)
        mut_seq_rc_final.append(mut_seq_rc)
        ref_seq_final_aa.append(ref_seq_aa)
        mut_seq_final_aa.append(mut_seq_aa)
        ref_seq_rc_final_aa.append(ref_seq_rc_aa)
        mut_seq_rc_final_aa.append(mut_seq_rc_aa)
        ref_seq_aa_match_final.append(ref_seq_aa_match)
        mut_seq_aa_match_final.append(mut_seq_aa_match)
        ref_seq_aa_rc_match_final.append(ref_seq_rc_aa_match)
        mut_seq_aa_rc_match_final.append(mut_seq_rc_aa_match)
    final_list.append(
        [aa_old]
        + [aa_new]
        + ref_seq_final
        ...
        + ref_seq_rc_final_aa
        + mut_seq_rc_final_aa
        + ref_seq_aa_match_final
        + mut_seq_aa_match_final
        + ref_seq_aa_rc_match_final
        + mut_seq_aa_rc_match_final
    )
